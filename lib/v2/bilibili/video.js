...
module.exports = async (ctx) => {
    ...
    await got(`https://space.bilibili.com/${uid}/video?tid=0&page=1&keyword=${keyword}&order=pubdate`, {
        headers: {
            Referer: `https://space.bilibili.com/${uid}/`,
            Cookie: cookie,
        },
    });
    const params = utils.addVerifyInfo(`mid=${uid}&ps=30&tid=0&pn=1&keyword=${keyword}&order=pubdate&platform=web&web_location=1550101&order_avoided=true`, verifyString);
